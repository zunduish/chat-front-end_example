  ...
  <div class="w-full flex justify-center items-center">
    ...
    <div v-if="store.status !== 'loading'" class="flex grow">
      ...
      <button
        ...
        aria-label="профайл зураг"
      >
        <div
          :style="{ backgroundImage: `url(${getAvatar(store.activeConversation)})`}"
      ...
      <div class="flex flex-col">
        <p
          ...
          tabindex="0"
        >
          {{ getName(store.activeConversation) }}
        </p>

        <p
          class="body-2 text-color font-extralight rounded-[.25rem]"
          tabindex="0"
          aria-label="2024-12-16-нд сүүлд харсан"
        >
          Хамгийн сүүлд 2024 оны 12-р сарын 16-нд харсан
        </p>
      </div>
    </div>
    ...
    <div class="flex" :class="{ hidden: store.status === 'loading' }">
      ...
      <div class="relative">
        ...
        <IconButton
          ...
          title="харилцан ярианы цэсийг сэлгэх"
          aria-label="харилцан ярианы цэсийг сэлгэх"
        >
        ...
        >
          ...
          <button
            class="dropdown-link dropdown-link-primary"
            aria-label="энэ харилцагчтай дуут дуудлага эхлүүлэх"
            role="menuitem"
            @click="
              () => {
                handleCloseDropdown();
          ...
          <button
            class="dropdown-link dropdown-link-primary"
            aria-label="энэ харилцагчийг хуваалц"
            role="menuitem"
          ...
          <button
            ...
            aria-label="энэ харилцагчийг хориглох"
            role="menuitem"
            @click="handleCloseDropdown"
          >
            <NoSymbolIcon class="h-5 w-5 mr-3" />
            Холбогдохыг хориглох
          </button>
        </Dropdown>
      </div>
    </div>
