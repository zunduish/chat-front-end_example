<template>
  ...
  <div
    ...
    tabindex="0"
    aria-label="дуут мессеж"
  >
    <div v-if="loading" class="p-4 mr-4 flex justify-center items-center rounded-[.75rem] outline-none transition-all duration-200 bg-indigo-300 active:bg-indigo-400">
      <Spinner />
    </div>
