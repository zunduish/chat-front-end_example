    ...
    >
      ...
      >
        <p class="display mb-5 text-white">
          гайхалтай хурдан мессежийн платформ
          <span class="text-gradient">web.</span>
        </p>
        <p class="body-3 text-white">
          Хэрэглэгчийн төхөөрөмж дээрх бүх өгөгдлийг хадгалж,
          олон хөтөч болон төхөөрөмжүүдийн хооронд өгөгдлийг синк хийх протоколууд.
        </p>
      </div>
    </div>
  </div>
