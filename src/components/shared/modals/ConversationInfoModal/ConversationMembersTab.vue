<template>
  <div>
    ...
    <div class="flex justify-between items-center mb-6 px-5">
      <p id="modal-title" class="heading-1 text-color">Гишүүд</p>
    ...
    <div ref="contactContainer">
      <ScrollBox class="max-h-[14.5rem] overflow-y-scroll">
        ...
        >
          ...
          >
            <div class="ml-3">
              <p class="body-4 text-indigo-400">админ</p>
            </div>
          </template>
            ...
            <div>
              ...
              >
                <button
                  ...
                  aria-label="админ зөвшөөрөл өгөх"
                  role="menuitem"
                >
                  Админд сурталчлах
                </button>
                <button
                  class="dropdown-link dropdown-link-primary"
                  aria-label="админ зөвшөөрлийг устгах"
                  role="menuitem"
                >
                  Гишүүн болгох
                </button>
                <button
                  ...
                  aria-label="харилцагчдыг устгах"
                  role="menuitem"
                >
                  Харилцагчийг устгах
                </button>
