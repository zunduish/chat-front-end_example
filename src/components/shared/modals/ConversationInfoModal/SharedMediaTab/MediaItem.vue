<template>
  ...
  >
    ...
    >
      <PhotoIcon class="h-5 w-5 text-gray-500 dark:text-white dark:text-opacity-70" v-if="props.attachment.type === 'image'"/>
      <DocumentIcon class="h-5 w-5 text-gray-500 dark:text-white dark:text-opacity-70" v-else-if="props.attachment.type === 'file'"/>
      <VideoCameraIcon class="h-5 w-5 text-gray-500 dark:text-white dark:text-opacity-70" v-else-if="props.attachment.type === 'video'" />
    </div>
