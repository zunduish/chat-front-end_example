  ...
  <div class="w-full h-full pt-6 flex flex-col items-center">
    ...
    <div class="mb-9 flex">
      ...
      <div class="mr-5 first-letter:flex flex-col justify-center items-center">
        ...
        <p class="body-4 text-color">Нэмэх</p>
      </div>

      <!--mute sound-->
      <div class="mr-5 flex flex-col justify-center items-center">
        <IconButton class="ic-btn-contained-gray p-3 mb-3">
          <SpeakerXMarkIcon class="w-[1.0625rem] h-[1.0625rem] text-black text-opacity-60 dark:text-white dark:text-opacity-70"/>
        </IconButton>
        <p class="body-4 text-color">дуу хаах</p>
      </div>

      <!--open chat-->
      <div class="flex flex-col justify-center items-center">
        <IconButton class="ic-btn-contained-gray p-3 mb-3">
          <ChatBubbleBottomCenterTextIcon class="w-[1.0625rem] h-[1.0625rem] text-black text-opacity-60 dark:text-white dark:text-opacity-70"/>
        </IconButton>
        <p class="body-4 text-color">Чат</p>
      </div>
    </div>

    <!--call actions-->
    <div class="relative w-full h-[3.125rem] rounded-b flex justify-center bg-gray-50 dark:bg-gray-700">
      <div class="absolute bottom-[1.1875rem]">
        <div class="p-3 rounded-full bg-white dark:bg-gray-800">
          <IconButton @click=" () => { props.closeModal(); } " class="ic-btn-contained-danger p-[1.0625rem]">
