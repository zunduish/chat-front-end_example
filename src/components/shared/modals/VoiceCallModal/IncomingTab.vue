<template>
  <div class="w-full h-full py-6 flex flex-col items-center">
    ...
    <div class="flex">
      ...
      <!--reject button-->
      <IconButton @click=" () => { props.closeModal(); }" class="ic-btn-contained-danger relative p-[1.0625rem]">
        <XMarkIcon class="w-[1rem] h-[1rem]" />
        <span class="animate-ping absolute inline-flex w-[2.1875rem] h-[2.1875rem] rounded-full bg-red-400 opacity-75"></span>
      </IconButton>
    </div>
  </div>
</template>
