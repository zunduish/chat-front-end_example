...
<template>
  <div>
    ...
    <div class="px-5 flex justify-between items-center">
      <p id="modal-title" class="heading-1 text-color text-[14px] leading-5" tabindex="0">
        Дуудлагын дэлгэрэнгүй мэдээлэл
      </p>

      <Button @click="props.closeModal" class="outlined-danger ghost-text py-2 px-4">
        Цуцлах
        <!--        esc-->
      </Button>
    </div>
    ...
    <div v-if="props.call" class="w-full py-7">
      ...
      <div class="px-5 pb-5 flex items-center">
        <IconAndText :icon="CallStatusIcon" title="дуудлага хүлээн авсан" />
